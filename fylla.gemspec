...
Gem::Specification.new do |s|
  ...
  s.homepage    = "https://github.com/snowe2010/fylla"
  ...
  s.license     = "MIT"
  s.metadata    = {
    "homepage_uri"    => "https://github.com/snowe2010/fylla",
    "changelog_uri"   => "https://github.com/snowe2010/fylla/blob/master/CHANGELOG.md",
    "source_code_uri" => "https://github.com/snowe2010/fylla",
    "bug_tracker_uri" => "https://github.com/snowe2010/fylla/issues",
  }

  s.required_ruby_version = ">= 3.2.0"

  s.files = Dir["README.md", "CHANGELOG.md", "LICENSE", "lib/**/*.rb", "exe/*"]
